...
connstr = "Endpoint=sb://cit-rd-plankton-svcbus.servicebus.windows.net/;SharedAccessKeyName=XXXXXXXXXXXXXXXXXXXXXXXXXXXXX;SharedAccessKey=XXXXXXXXXXXXXXXXXXXXXXXX="
