...
class UnifiedApp:
    ...
    def build_local_watcher_tab(self):
        ...
        self.local_output_folder_entry.insert(0, os.path.join(os.path.expanduser("~/Documents/flowcytometertool"), "results/"))
    ...
    def create_widgets(self):
        ...
        notebook.add(self.tab_local_watcher, text="Sample analyser")
