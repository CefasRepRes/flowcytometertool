...
import datetime
import pickle
from functions import active_model_dir, resolve_active_model_path 
...
def splitTrainingSet(training_set, target_name, group_name, weight_name):
    ...
    columns_to_drop = [target_name, group_name, weight_name, "Particle_ID", "TriggerLevel",'sample_weight']
